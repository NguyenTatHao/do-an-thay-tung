...
{   
    ...
    public function render()
    {
        ...
        {
            $product = Product::where('name','like',$this->search_term)->orderBy('created_at','ASC')->paginate($this->pageSize);
        }
        else{
            $product = Product::where('name','like',$this->search_term)->paginate($this->pageSize);
        }
        $categories = Category::orderBy('name','ASC')->get();
        return view('livewire.search-component',['products'=>$product,'categories'=>$categories]);
    }
}
