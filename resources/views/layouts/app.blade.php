            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Phone</span> (+84) 0123456789 </p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>70 Nguyễn Huệ, Vĩnh Ninh, Thành phố Huế, Thừa Thiên Huế
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>(+84) 0123456789
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>royalrevolt24680@gmail.com
                            </p>
