                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <button type="button" class="button button-add-to-cart" wire:click.prevent="store({{ $product->id }}, '{{ addslashes($product->name) }}', {{ $product->regular_price }})">Add to cart</button>
